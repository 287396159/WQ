...
public class ConstantUtil {
    ...
    public static String[] SOUND_ALARM_MODE = {"Gradual","Fixed","Sound Alarm"};

    public static  int ERROR_OPERATE = -1;
    public static int SET_ONE_OPERATE = 0;
    public static int READ_ONE_OPERATE = 1;
    public static int READ_ALL_OPERATE = 2;
    public static int RUNOUTTIMECOUNT=0;
}
